...
const translations = {
	en: {
		...
		storyText: `Picture this: you're vibing to music at home, and your kid suddenly shouts <em>"I LOVE this song! Add it to my playlist!"</em> — every. single. time. So instead of grabbing a phone, unlocking it, opening Spotify, searching, adding... we now just <span class="text-green-600 font-semibold">press a button</span>. ✨`,
		step1Title: "Listen",
    ...
    <html lang="${lang}">
      ...
      <body class="gradient-bg min-h-screen">
        ...
        <nav class="flex justify-end gap-2 p-4 md:p-6">
          <a
            href="?lang=${otherLang}"
            class="flex items-center gap-2 bg-black/5 hover:bg-black/10 border border-black/10 rounded-full px-4 py-2 transition-all font-semibold"
          >
            ${otherLangLabel}
          </a>
          <a
